#ifndef __TUFF_TOKEN_H_
#define __TUFF_TOKEN_H_
...
#define TUFF_TOKEN_LIST							\
    ...
    TUFF_TOKEN (INT_LITERAL, "integer literal")				\
...
inlined Token
make_token (int id, Location locus, StringView sv) {
    return (Token) { id, locus, sv };
}

inlined Token
make_token_x (int id, Location locus) {
